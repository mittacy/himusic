...
func newApp(logger log.Logger, hs *http.Server, gs *grpc.Server, greeter *service.PaperService) *kratos.App {
	pb.RegisterPaperServer(gs, greeter)
	pb.RegisterPaperHTTPServer(hs, greeter)
	return kratos.New(
		kratos.Name(Name),
