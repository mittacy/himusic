...
func newApp(logger log.Logger, hs *http.Server, gs *grpc.Server, community *service.CommunityService) *kratos.App {
	pb.RegisterCommunityServiceServer(gs, community)
	pb.RegisterCommunityServiceHTTPServer(hs, community)
	return kratos.New(
		kratos.Name(Name),
