...
func newApp(logger log.Logger, hs *http.Server, gs *grpc.Server, user *service.UserService) *kratos.App {
	pb.RegisterUserServer(gs, user)
	pb.RegisterUserHTTPServer(hs, user)
	return kratos.New(
		kratos.Name(Name),
