...
func newApp(logger log.Logger, hs *http.Server, gs *grpc.Server, greeter *service.CoinsService) *kratos.App {
	pb.RegisterCoinsServer(gs, greeter)
	pb.RegisterCoinsHTTPServer(hs, greeter)
	return kratos.New(
		kratos.Name(Name),
